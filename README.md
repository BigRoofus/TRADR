...
### Flat (All, 50%, or 25%)
Flatting closes out positions, in whole or in part.  Reasons for not closing out trades a bit at at time include [scaling out](https://www.investopedia.com/terms/s/scale-out.asp).
